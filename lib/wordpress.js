 ...
 * Website Visual Review, 31.08.2026). Both the nav label and the browser
 * title come from the WordPress page title, and the menu REST endpoints are
 * closed to us — getMenu() falls through to building the nav from page
 * titles — so the rename is applied where those titles become visible.
 *
